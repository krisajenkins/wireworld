...
var _krisajenkins$elm_cdn$CDN$stylesheet = function (url) {
	return A3(
...
var _krisajenkins$elm_cdn$CDN$script = function (url) {
	return A3(
		_elm_lang$html$Html$node,
		'script',
		_elm_lang$core$Native_List.fromArray(
...
var _krisajenkins$elm_cdn$CDN$bulma = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/bulma/0.1.2/css/bulma.min.css')
};
var _krisajenkins$elm_cdn$CDN$fontAwesome = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css')
};
var _krisajenkins$elm_cdn$CDN$foundation = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/foundation/6.2.3/foundation.min.css'),
	js: _krisajenkins$elm_cdn$CDN$script('https://cdnjs.cloudflare.com/ajax/libs/foundation/6.2.3/foundation.min.js')
};
var _krisajenkins$elm_cdn$CDN$reset = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css')
};
var _krisajenkins$elm_cdn$CDN$skeleton = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/skeleton/2.0.4/skeleton.min.css')
};
var _krisajenkins$elm_cdn$CDN$bootstrap = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'),
	theme: _krisajenkins$elm_cdn$CDN$stylesheet('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.min.css'),
...
var _user$project$State$neighbours = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1._1;
	var _p2 = _p1._0;
	return _elm_lang$core$Native_List.fromArray(
		[
			...
			{ctor: '_Tuple2', _0: _p2 - 0, _1: _p3 - 1},
			{ctor: '_Tuple2', _0: _p2 + 1, _1: _p3 - 1},
			{ctor: '_Tuple2', _0: _p2 - 1, _1: _p3 + 0},
			{ctor: '_Tuple2', _0: _p2 + 1, _1: _p3 + 0},
			{ctor: '_Tuple2', _0: _p2 - 1, _1: _p3 + 1},
			{ctor: '_Tuple2', _0: _p2 - 0, _1: _p3 + 1},
			{ctor: '_Tuple2', _0: _p2 + 1, _1: _p3 + 1}
...
var _user$project$State$countNeighbouringHeads = F2(
	function (world, coord) {
		return _elm_lang$core$List$length(
			A2(
				...
				F2(
					...
					})(_user$project$Types$Head),
				A2(
					_elm_lang$core$List$filterMap,
					A2(_elm_lang$core$Basics$flip, _robertjlooby$elm_generic_dict$GenericDict$get, world),
					_user$project$State$neighbours(coord))));
	});
var _user$project$State$tickCell = F3(
	function (world, coord, cell) {
		var _p4 = cell;
		switch (_p4.ctor) {
			case 'Empty':
				return _user$project$Types$Empty;
			case 'Head':
				return _user$project$Types$Tail;
			case 'Tail':
				return _user$project$Types$Conductor;
			default:
				var _p5 = A2(_user$project$State$countNeighbouringHeads, world, coord);
				switch (_p5) {
					case 1:
						return _user$project$Types$Head;
					case 2:
						return _user$project$Types$Head;
					default:
						return _user$project$Types$Conductor;
...
var _user$project$State$toggleCell = function (maybeCell) {
	var _p6 = maybeCell;
	if (_p6.ctor === 'Nothing') {
		return _elm_lang$core$Maybe$Just(_user$project$Types$Head);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
...
var _user$project$View$cellColor = function (cell) {
	var _p0 = cell;
	switch (_p0.ctor) {
		case 'Empty':
			return 'black';
...
var _user$project$View$gridOf = F2(
	function (xs, ys) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Basics$toString(
						_elm_lang$core$Basics$fst(coord) * (_user$project$View$cellSize + 1))),
					_elm_lang$svg$Svg_Attributes$y(
					_elm_lang$core$Basics$toString(
						(_elm_lang$core$Basics$snd(coord) + 1) * (_user$project$View$cellSize + 1))),
					_elm_lang$svg$Svg_Attributes$width(
					_elm_lang$core$Basics$toString(_user$project$View$cellSize)),
					_elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(_user$project$View$cellSize)),
					_elm_lang$svg$Svg_Attributes$fill(
					_user$project$View$cellColor(cell)),
					_elm_lang$svg$Svg_Events$onClick(
					_user$project$Types$ToggleCell(coord))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$View$circuitView = function (world) {
	return A3(
		...
		A2(
			...
			function (coord) {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toString(coord),
					_1: A2(
						_user$project$View$cellView,
						coord,
						A2(
							_elm_lang$core$Maybe$withDefault,
							_user$project$Types$Empty,
							A2(_robertjlooby$elm_generic_dict$GenericDict$get, coord, world)))
				};
			},
			A2(
				_user$project$View$gridOf,
				_elm_lang$core$Native_List.range(0, _user$project$View$gridSizeX - 1),
				_elm_lang$core$Native_List.range(0, _user$project$View$gridSizeY - 1))));
};
var _user$project$View$root = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_krisajenkins$elm_cdn$CDN$skeleton.css,
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://en.wikipedia.org/wiki/Wireworld')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://github.com/krisajenkins/wireworld')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_user$project$View$circuitView(model.world),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Click a cell to toggle it.')
					]))
			]));
};
